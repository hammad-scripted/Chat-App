...
export const SettingsPage = () => {
  ...
  return (
    <div className="min-h-screen w-screen bg-base-200 container mx-auto px-4 sm:px-6 pt-20 pb-8 max-w-5xl">
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-1 sm:gap-2">
          {THEMES.map((t) => (
            <button
              key={t}
              className={`
                group flex flex-col items-center gap-1 p-1 sm:p-2 rounded-lg transition-colors
        ...
        {/* Preview Section */}
        <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-5 mt-6 sm:mt-8">Preview</h3>
